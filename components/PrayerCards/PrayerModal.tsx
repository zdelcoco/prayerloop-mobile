...
interface PrayerModalProps {
  visible: boolean;
  onEditPrayer: (prayerData: CreateUserPrayerRequest) => void;
  onClose: () => void;
}
...
export default function PrayerModal({
  ...
  }, [prayerTitle, prayerDescription, isPrivate, onEditPrayer, onClose, resetForm]);

  const cancelEditPrayer = useCallback(() => {
    resetForm();
    onClose();
  }, [resetForm, onClose]);
    ...
    >
      ...
      >
        <View style={styles.modalContainer}>
          <Text style={styles.modalTitle}>{prayerTitle}</Text>
          {/* <TextInput
            style={styles.input}
          ...
          <View style={styles.buttonContainer}>
            <Pressable style={styles.button} onPress={cancelEditPrayer}>
